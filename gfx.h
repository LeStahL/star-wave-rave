     ...
     "else"
       " if(iTime<14.)"
         "{"
           ...
           "sdf=add(sdf,vec4(dca,c.xxx));"
           "sdf=add(sdf,vec4(dc,c.xyy));"
           "col=sdf.yzw*smoothstep(1.5/iResolution.y,-1.5/iResolution.y,sdf.x)*blend(12.,13.,.5);"
         "}"
       "else"
         " if(iTime<16.)"
           "{"
             ...
             "sdf=add(sdf,vec4(dca,c.xxx));"
             "sdf=add(sdf,vec4(dc,c.xyy));"
             "col=sdf.yzw*smoothstep(1.5/iResolution.y,-1.5/iResolution.y,sdf.x)*blend(14.,15.,.5);"
           "}"
         "else"
           " if(iTime<50.)"
             "{"
                   ...
                   "else"
                     " if(iTime<76)"
                       "{"
                         ...
                         "bool hit;"
                         "vec2 s;"
                         "raymarch(scene2,x,ro,d,dir,s,300,.0001,hit);"
                         "if(hit==false)"
                           "{"
                             "post(col,uv);"
                             "fragColor=vec4(col,1.);"
                         ...
                         "for(float i=.7;i>=.3;i-=.2)"
                           "{"
                             ...
                             "d=.005;"
                             "ro=x;"
                             "raymarch(scene2,x,ro,d,dir,s,50,.0005,hit);"
                             "if(hit==false)"
                               "{"
                                 "post(col,uv);"
                                 "fragColor=vec4(col,1.);"
